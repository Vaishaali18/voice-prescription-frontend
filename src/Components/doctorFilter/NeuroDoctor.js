...
export default function App()
{
  ...
  const { userData, setUserData } = useContext(UserContext);
    ...
    useEffect(()=>{
        ...
        const getDetails = async () => {
            const res = await Axios.get("https://voice-prescription-ai.herokuapp.com/doctor/viewNeuro"); 
            setItems(res.data);
        }
        getDetails();
     },[])
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup" style = {{'margin-left' : '30%'}}>
    <div class="navbar-nav">
      ...
      <a class="nav-item nav-link active" href="/admin/view/neurologist" style={{'margin-right' : '3vw'}}>Neurologist</a>
