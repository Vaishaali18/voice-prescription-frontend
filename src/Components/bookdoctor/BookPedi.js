...
export default function App()
{
  ...
  useEffect(()=>{
      ...
      const getDetails = async () => {
          const res = await Axios.get("https://voice-prescription-ai.herokuapp.com/users/bookPedi"); 
          setItems(res.data);
      }
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup" style = {{'margin-left' : '30%'}}>
      <div class="navbar-nav">
        ...
        <a class="nav-item nav-link active" href="/patient/book/pediatrician" style={{'margin-right' : '3vw','color':'white'}}>Pediatrician</a>
