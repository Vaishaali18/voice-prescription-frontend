...
export default function App()
{
  ...
  useEffect(()=>{
      ...
      const getDetails = async () => {
          const res = await Axios.get("https://voice-prescription-ai.herokuapp.com/users/book"); 
          setItems(res.data);
      }
      ...
      getProfile();
       ...
       <div>
        <header>
          ...
          <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-dark" style ={{'padding' :'0px','marginTop':'7vw', 'zIndex' : '1','marginBottom':'-1500px'}}>
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup" style = {{'margin-left' : '30%'}}>
      <div class="navbar-nav">
        ...
        <main>
          ...
          <div class="container" style ={{'margin-left':'4vw','marginTop':'2vw'}}>
